...
import {
  ...
  unauthorizedResponseWithMessage,
  errorResponse,
...
describe('api-responses', () => {
  ...
  it('unauthorizedResponseWithMessage returns 401 with custom message', async () => {
    const response = unauthorizedResponseWithMessage('Token expired');
    expect(response.status).toBe(401);
