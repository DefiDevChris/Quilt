 ...
 *
 * Build printlist items from parsed pattern data.
 */

import type { ParsedPattern, ParsedBlock } from './pattern-parser-types';
import type { FabricMatch } from './pattern-fabric-matcher';
import type { ImportedPrintlistItem } from './pattern-import-types';
import {
  findFabricMatch,
  generateShapeId,
  generateShapeSvg,
