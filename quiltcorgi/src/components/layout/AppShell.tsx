              ...
              {user?.role === 'free' && (
                <div className="flex items-center gap-2 mr-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary to-primary-golden px-3 py-1 text-xs font-extrabold text-white shadow-elevation-1 hover:shadow-elevation-2 transition-all hover:shadow-elevation-2 hover:brightness-95"
                  >
