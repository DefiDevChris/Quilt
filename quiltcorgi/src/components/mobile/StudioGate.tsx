...
export function StudioGate() {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-8 text-center">
      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--color-outline-variant)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="mb-6">
      ...
      <p className="text-sm text-secondary leading-relaxed max-w-xs mb-8">
        Open QuiltCorgi on a desktop to continue editing. The full design studio needs a larger screen.
      </p>
      <Link
        href="/dashboard"
