      ...
      <div className="grid grid-cols-12 auto-rows-[minmax(140px,auto)] md:grid-rows-[280px_200px_160px] gap-6 pb-20 relative z-10">
        ...
        >
          ...
          <div className="relative z-10 mt-auto">
            <p className="text-on-surface font-extrabold text-2xl tracking-tight leading-none mb-2">Blank Project</p>
            <p className="text-secondary text-sm font-medium">Start from scratch with a custom grid/layout</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="relative z-10 mt-auto">
            <p className="text-on-surface font-extrabold text-2xl tracking-tight leading-none mb-2">Start from Template</p>
            <p className="text-secondary text-sm font-medium">Browse the Pattern Library for a pre-made layout</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="relative z-10 mt-auto">
            ...
            <p className="text-secondary text-sm font-medium">Upload a photo to automatically detect patterns</p>
          </div>
        </button>
