...
export default function TutorialsPage() {
  ...
  const tutorialFrontmatters = tutorials.map(
    ({ content: _content, ...frontmatter }) => frontmatter
  );
    ...
    <>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-body-lg lg:text-headline-sm text-secondary max-w-2xl mx-auto">
          Step-by-step tutorials to help you create beautiful quilts. From first-time basics to
          advanced techniques.
        </p>
