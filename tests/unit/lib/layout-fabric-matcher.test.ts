import { matchPatternFabrics, inferColorHex, levenshteinDistance } from '@/lib/layout-fabric-matcher';
import type { ParsedFabric } from '@/lib/layout-parser-types';
import type { FabricRecord } from '@/lib/layout-fabric-matcher';
