import { matchPatternBlock, generateCustomBlockSvg, normalizeBlockName } from '@/lib/layout-block-matcher';
import type { ParsedBlock } from '@/lib/layout-parser-types';
import type { BlockLibraryEntry } from '@/lib/layout-block-matcher';
