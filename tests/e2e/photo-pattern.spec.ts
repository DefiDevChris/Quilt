...
/** Navigate to the Photo to Pattern page as a pro user. */
async function navigateToPhotoPattern(page: Page) {
  ...
  await page.goto('/photo-to-pattern');
...
test.describe('Photo to Pattern — Access & Navigation', () => {
  test('pro user can access the page with correct heading', async ({ page }) => {
    const wizard = await navigateToPhotoPattern(page);
    await expect(wizard).toBeVisible();
    await expect(page.getByRole('heading', { name: 'Photo to Pattern' })).toBeVisible();
  });
...
test.describe('Photo to Pattern — Upload Step', () => {
...
test.describe('Photo to Pattern — Image Prep Step', () => {
...
test.describe('Photo to Pattern — Scan Settings Step', () => {
...
test.describe('Photo to Pattern — Quilt Details Step', () => {
...
test.describe('Photo to Pattern — Correction Step', () => {
...
test.describe('Photo to Pattern — Processing Step', () => {
...
test.describe('Photo to Pattern — Step Indicators', () => {
...
test.describe('Photo to Pattern — Wizard Forward Navigation', () => {
