...
- Name: landing.spec.ts >> SEO >> robots.txt is accessible
- Location: tests/e2e/landing.spec.ts:104:7
...
Disallow: /studio/
Disallow: /profile/·
Sitemap: https://quiltcorgi.com/sitemap.xml
"
```
...
```yaml
- generic [ref=e2]: "User-Agent: * Allow: / Disallow: /api/ Disallow: /admin/ Disallow: /studio/ Disallow: /profile/ Sitemap: https://quiltcorgi.com/sitemap.xml"
```
