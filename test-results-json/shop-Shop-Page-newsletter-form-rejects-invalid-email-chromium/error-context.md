...
- Name: shop.spec.ts >> Shop Page >> newsletter form rejects invalid email
- Location: tests/e2e/shop.spec.ts:72:7
...
Locator: getByText(/valid email/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/valid email/i)
...
- generic [ref=e1]:
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e420]:
      ...
      - generic [ref=e427]:
        - textbox "Email address for newsletter" [active] [ref=e428]:
