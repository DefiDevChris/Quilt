...
- Name: admin.spec.ts >> Admin Access >> admin layouts page redirects non-admin users
...
waiting for navigation until "load"
  navigated to "http://localhost:3000/admin/layouts"
============================================================
```
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e35]:
      - banner [ref=e36]:
        - heading "Layouts" [level=3] [ref=e38]
      ...
      - main [ref=e42]:
        - generic [ref=e43]:
          - generic [ref=e44]:
            - generic [ref=e45]:
              - heading "Layout Templates" [level=1] [ref=e46]
              - paragraph [ref=e47]: Manage quilt layout templates available in the studio
            - button "Add Layout" [ref=e48]:
              - img [ref=e49]
              - text: Add Layout
          - paragraph [ref=e52]: No layout templates yet. Create your first layout!
