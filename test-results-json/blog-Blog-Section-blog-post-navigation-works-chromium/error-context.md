...
- Name: blog.spec.ts >> Blog Section >> blog post navigation works
- Location: tests/e2e/blog.spec.ts:56:7
...
Call log:
  - waiting for getByRole('button').filter({ hasText: /QuiltCorgi Team/i }).first()
