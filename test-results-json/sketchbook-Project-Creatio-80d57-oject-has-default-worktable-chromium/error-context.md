...
- Name: sketchbook.spec.ts >> Project Creation >> new project has default worktable
- Location: tests/e2e/sketchbook.spec.ts:60:7
...
Locator: getByText(/worktable 1/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/worktable 1/i)
  ...
  - generic [ref=e4]:
    ...
    - main [ref=e16]:
      - generic [ref=e19]:
        ...
        - dialog "New Project" [ref=e70]:
          - generic [active] [ref=e71]:
            - generic [ref=e72]:
              - heading "New Project" [level=2] [ref=e73]
              - button "Close" [ref=e74]:
                - img [ref=e75]
            - generic [ref=e78]:
              - generic [ref=e79]:
                - generic [ref=e80]: Name your project
                - textbox "Name your project" [ref=e81]:
                  - /placeholder: e.g. My Next Masterpiece
              - button "Next Step" [disabled] [ref=e83]
