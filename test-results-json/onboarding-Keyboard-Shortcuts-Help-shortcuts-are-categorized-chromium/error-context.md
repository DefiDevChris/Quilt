...
- Name: onboarding.spec.ts >> Keyboard Shortcuts Help >> shortcuts are categorized
- Location: tests/e2e/onboarding.spec.ts:144:7
...
Locator:  getByText(/general|editing/i)
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByText(/general|editing/i)
    9 × locator resolved to <p class="text-sm text-[var(--color-text-dim)] leading-relaxed max-w-xs mb-8">Open Quilt Studio on a desktop to continue editin…</p>
