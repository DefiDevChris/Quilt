...
- Name: billing.spec.ts >> Subscription Management >> can view subscription status
- Location: tests/e2e/billing.spec.ts:40:7
...
Locator: getByText(/active|subscription|pro/i)
Expected: visible
Error: strict mode violation: getByText(/active|subscription|pro/i) resolved to 3 elements:
    ...
    3) <div id="nextjs__container_errors_desc" class="nextjs__container_errors_desc ">…</div> aka getByText('eval() is not supported in')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/active|subscription|pro/i)
