...
- Name: billing.spec.ts >> Upgrade Flow >> monthly plan option is available
- Location: tests/e2e/billing.spec.ts:93:7
...
Locator: getByText(/month|monthly|\$/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/month|monthly|\$/i)
