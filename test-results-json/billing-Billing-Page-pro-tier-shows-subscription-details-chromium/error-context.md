...
- Name: billing.spec.ts >> Billing Page >> pro tier shows subscription details
- Location: tests/e2e/billing.spec.ts:17:7
...
Locator: getByText(/subscription|pro|active/i)
Expected: visible
Error: strict mode violation: getByText(/subscription|pro|active/i) resolved to 3 elements:
...
Call log:
  ...
  - waiting for getByText(/subscription|pro|active/i)
