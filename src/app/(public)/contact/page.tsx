    ...
    <div className="max-w-3xl mx-auto px-6 py-16 lg:py-24">
      ...
      <div className="mt-16 max-w-2xl mx-auto">
        <a
          ...
          className="block p-12 bg-surface border border-default rounded-lg shadow-elevated hover:bg-[var(--color-primary)]/10 transition-colors duration-150"
        >
          ...
          <div className="space-y-4">
            <p className="text-[18px] leading-[28px] text-dim">
              Have a question about your account, a feature request, or need help with a
