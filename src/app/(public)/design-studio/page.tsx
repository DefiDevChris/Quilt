...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'A modern, browser-based quilt design studio. Free to start.',
    type: 'website',
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link href="/shop" className="text-sm font-semibold hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Shop Fabrics</Link>
            <Link href="/help" className="text-sm font-semibold hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Guides</Link>
            <div className="h-4 w-[1px] bg-slate-200 mx-2" />
            <Link href="/auth/signin" className="text-sm font-semibold hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Sign In</Link>
            <Link 
              href="/auth/signup" 
      ...
      <section className="relative overflow-hidden pt-16 lg:pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-xl leading-relaxed mb-12 max-w-xl mx-auto lg:mx-0" style={{ color: COLORS.textDim }}>
              QuiltCorgi Design Studio brings professional design tools to your browser. 
              No installation required. Arrange blocks, test fabric stories, and export 
              ready-to-sew PDF patterns in minutes.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Link 
                ...
                style={{ background: COLORS.primary, color: '#fff', boxShadow: `0 8px 30px ${COLORS.primary}44` }}
              >
            ...
            <p className="mt-8 text-sm flex items-center gap-2 justify-center lg:justify-start" style={{ color: COLORS.textDim }}>
              <span className="flex">
                {[1,2,3,4,5].map(i => (
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="group">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold" style={{ color: COLORS.text }}>100+ Block Library</h3>
              </div>
              <p className="leading-relaxed" style={{ color: COLORS.textDim }}>
                Access a massive library of classic and modern blocks. Use the custom 
                builder to create unique patterns that are truly your own.
              </p>
            </div>
            ...
            <div className="group">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold" style={{ color: COLORS.text }}>Live Fabric Sandbox</h3>
              </div>
              <p className="leading-relaxed" style={{ color: COLORS.textDim }}>
                Instantly swap fabrics from curated modern collections. See how prints 
                and colors interact on your actual quilt before buying a yard.
              </p>
            </div>
            ...
            <div className="group">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold" style={{ color: COLORS.text }}>Pro Pattern Export</h3>
              </div>
              <p className="leading-relaxed" style={{ color: COLORS.textDim }}>
                Export precise 1:1 PDF patterns with cutting instructions, seam allowances, 
                and accurate yardage calculation for any size project.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-12 border-t" style={{ borderColor: `${COLORS.text}1a` }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8">
            <Link href="/terms" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Terms</Link>
            <Link href="/privacy" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Privacy</Link>
            <Link href="/contact" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors" style={{ color: COLORS.textDim }}>Contact</Link>
          </div>
        </div>
      </footer>
    </div>
