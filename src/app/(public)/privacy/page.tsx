  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 lg:py-24">
        <div className="mb-20">
          <h1
            className="text-[40px] leading-[52px] font-normal text-default mb-6"
        ...
        <div className="text-dim space-y-10 max-w-2xl mx-auto text-[14px] leading-[20px]">
          <p>
          ...
          <section>
            ...
            <h3 className="text-[24px] leading-[32px] font-normal text-default mt-5 mb-2">
