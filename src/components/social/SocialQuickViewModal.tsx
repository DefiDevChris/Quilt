      ...
      <div className="quick-view-panel">
        ...
        <div className="quick-view-panel-header">
          <Link href={profileHref} className="quick-view-panel-avatar">
            {item.creatorAvatarUrl ? (
              ...
              <div className="w-full h-full rounded-full bg-neutral-100 flex items-center justify-center text-sm font-semibold text-neutral-600">
        ...
        <div className="quick-view-panel-actions">
          ...
          <Link
            ...
            className="text-sm font-medium text-neutral-600 hover:text-neutral-800 flex items-center gap-1"
          >
  ...
  return (
    <>
      ...
      <div className="quick-view-panel">
        ...
        <div className="quick-view-panel-caption">
          <p className="text-xs text-neutral-600 mb-1 uppercase tracking-wide">{item.category}</p>
          <h2 className="font-serif text-lg font-semibold text-neutral-800 leading-snug">{item.title}</h2>
          {item.excerpt && <p className="text-sm text-neutral-600 mt-2 leading-relaxed">{item.excerpt}</p>}
        </div>
        <div className="quick-view-panel-actions">
          <div className="post-card-action-spacer" />
          <Link
