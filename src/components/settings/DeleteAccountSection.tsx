  ...
  return (
    <div className="space-y-10 py-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-[14px] leading-[20px] mb-1" style={{ color: COLORS.primary }}>
            Account Settings
          </p>
      ...
      <div
        className="rounded-lg p-8 space-y-8 relative overflow-hidden"
        style={{
          ...
          <div className="flex-1 space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-[16px] leading-[24px] text-[var(--color-text-dim)] max-w-xl">
                This will permanently remove all your projects, fabric archives, community designs,
