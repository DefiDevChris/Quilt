  ...
  return (
    <div className="space-y-10 py-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-wide text-error mb-1">Critical Operations</p>
          <h2 className="text-xl font-bold text-neutral-800 uppercase tracking-tight italic">Administrative Deletion</h2>
        </div>
      </div>

      <div className="rounded-full border border-error/20 bg-error/5 p-8 space-y-8 relative overflow-hidden">
        {/* Subtle decorative "DANGER" watermark */}
        <div className="absolute -bottom-4 -right-4 text-7xl font-bold text-error opacity-[0.03] select-none pointer-events-none rotate-12">
          DANGER
        </div>

        <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
          <div className="w-12 h-12 rounded-full bg-error/10 flex items-center justify-center flex-shrink-0 border border-error/20">
            <Mail size={24} className="text-error" />
          </div>

          <div className="flex-1 space-y-6">
            <div className="space-y-3">
              <h3 className="text-sm font-bold text-neutral-800 uppercase tracking-widest flex items-center gap-3">
            ...
            <button
              ...
              className="group flex items-center gap-4 px-8 py-4 bg-neutral-800 text-neutral rounded-full text-xs font-bold tracking-wide hover:bg-error hover:text-white transition-all duration-300 shadow-elevation-3 active:scale-[0.98]"
            >
