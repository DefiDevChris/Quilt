...
export function NewProjectWizard(props: NewProjectWizardInternalProps) {
 ...
 ref={dialogRef}
 tabIndex={-1}
 className={`w-full max-h-[90vh] overflow-y-auto bg-[#ffffff] border border-[#e8e1da] shadow-[0_1px_2px_rgba(45,42,38,0.08)] focus:outline-none ${isStudio ? 'max-w-lg' : 'max-w-2xl'
 }`}
 ...
 type="button"
 onClick={handleClose}
 className="text-[#6b655e] hover:text-[#2d2a26] w-8 h-8 flex items-center justify-center hover:bg-[#fdfaf7] transition-colors duration-150"
 style={{ borderRadius: '8px' }}
 aria-label="Close"
 >
 ...
 {error && (
 <div className="mx-6 mt-4 bg-[#ffc7c7]/30 border border-[#ffc7c7] px-4 py-2 text-sm text-[#2d2a26]" style={{ borderRadius: '8px' }}>
 {error}
 </div>
 )}
 ...
 className="w-full border border-[#e8e1da] px-4 py-3 text-[18px] leading-[28px] text-[#2d2a26] placeholder:text-[#6b655e] focus:outline-2 focus:outline-[#ff8d49]"
 style={{ borderRadius: '8px' }}
 autoFocus
 />
 </div>
 ...
 onClick={() => setStep(2)}
 disabled={!name.trim()}
 className="bg-[#ff8d49] text-[#2d2a26] px-6 py-2 text-[14px] leading-[20px] font-medium hover:bg-[#e67d3f] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
 style={{ borderRadius: '8px' }}
 >
 Next Step
 </button>
 ...
 className={
 isActive
 ? 'flex flex-col items-center justify-center p-3 bg-[#ff8d49] text-[#2d2a26] shadow-[0_1px_2px_rgba(45,42,38,0.08)]'
 : 'flex flex-col items-center justify-center p-3 bg-[#fdfaf7] text-[#2d2a26] hover:bg-[#ffc8a6]/20 transition-colors duration-150'
 }
 style={{ borderRadius: '8px' }}
 >
 ...
 className={
 isCustom
 ? 'w-full px-4 py-3 bg-[#ff8d49] text-[#2d2a26] text-[16px] leading-[24px] font-medium shadow-[0_1px_2px_rgba(45,42,38,0.08)]'
 : 'w-full px-4 py-3 bg-[#fdfaf7] text-[#2d2a26] text-[16px] leading-[24px] font-medium hover:bg-[#ffc8a6]/20 transition-colors duration-150 border border-[#e8e1da]'
 }
 style={{ borderRadius: '8px' }}
 >
 Custom Size
 ...
 type="button"
 onClick={() => setSizePresetLabel('Custom')}
 className={`flex items-center justify-center px-3 py-2.5 transition-colors duration-150 ${isCustom
 ...
 {isCustom && (
 <div className="grid grid-cols-2 gap-4 mt-2 p-4 bg-[#fdfaf7] border border-[#e8e1da]" style={{ borderRadius: '8px' }}>
 <div>
 ...
 className="w-full border border-[#e8e1da] px-3 py-2 text-[16px] leading-[24px] text-[#2d2a26] focus:outline-2 focus:outline-[#ff8d49]"
 style={{ borderRadius: '8px' }}
 placeholder="e.g. 60"
 />
 </div>
 ...
 className={`px-4 py-2 text-[16px] leading-[24px] font-medium transition-colors duration-150 ${Math.abs(cellSize - size) < 0.001
 ? 'bg-[#ff8d49] text-[#2d2a26] shadow-[0_1px_2px_rgba(45,42,38,0.08)]'
 ...
 className="bg-[#fdfaf7] border border-[#e8e1da] px-4 py-2 text-[16px] leading-[24px] font-medium text-[#6b655e] hover:bg-[#ffc8a6]/20 transition-colors duration-150"
 style={{ borderRadius: '8px' }}
 >
 Skip
 </button>
