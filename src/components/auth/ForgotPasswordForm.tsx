          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-default border-b border-default focus:border-primary rounded-lg px-3 py-2.5 pr-10 text-base text-default placeholder:text-dim outline-none transition-colors duration-150"
