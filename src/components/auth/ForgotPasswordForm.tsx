      ...
      <div className="auth-form-inner">
        ...
        {step === 'request' ? (
          <form onSubmit={handleRequestReset} className="space-y-5">
            <div>
              <label htmlFor="reset-email" className="block text-sm font-medium text-default mb-2">
                Email
              </label>
              <input
                id="reset-email"
          ...
          <form onSubmit={handleConfirmReset} className="space-y-5">
            <div>
              <label htmlFor="reset-code" className="block text-sm font-medium text-default mb-2">
                Reset Code
              </label>
              <input
                id="reset-code"
            ...
            <div>
              <label htmlFor="new-password" className="block text-sm font-medium text-default mb-2">
                New Password
              </label>
