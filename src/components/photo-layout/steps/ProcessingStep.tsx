...
import type { PipelineStepStatus } from '@/lib/photo-layout-types';
...
export function ProcessingStep() {
  ...
  const scanConfig = usePhotoLayoutStore((s) => s.scanConfig);
  const pipelineSteps = usePhotoLayoutStore((s) => s.pipelineSteps);
  ...
  const setQuiltStructure = usePhotoLayoutStore((s) => s.setQuiltStructure);
