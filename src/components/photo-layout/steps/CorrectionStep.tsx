...
export function CorrectionStep() {
  ...
  const perspectiveCorners = usePhotoLayoutStore((s) => s.perspectiveCorners);
  const setPerspectiveCorners = usePhotoLayoutStore((s) => s.setPerspectiveCorners);
  ...
  return (
    <div className="flex flex-col gap-3 h-full">
      ...
      <div className="flex items-center justify-between flex-shrink-0">
        ...
        <button type="button" onClick={handleRenderPattern} className="btn-primary-sm">
          Render Pattern
        </button>
      </div>
    </div>
