...
export default function FeatureHighlights() {
  return (
    <section id="features" className="px-6 lg:px-12 py-16 lg:py-24 bg-[#fdfaf7] relative overflow-hidden">
      ...
      <QuiltPiece color="primary" size={120} rotation={15} top={20} right="5%" opacity={6} />
      <QuiltPiece color="accent" size={90} rotation={-10} bottom={60} left="8%" opacity={8} />
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="absolute top-2 right-2 opacity-5 pointer-events-none">
                <QuiltPiece color="secondary" size={40} rotation={10} stitch={false} />
              </div>
