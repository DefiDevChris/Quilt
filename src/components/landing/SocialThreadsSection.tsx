...
function SocialThreadsScreenshot() {
  return (
    <div className="relative">
      <div className="bg-surface rounded-lg shadow-brand border border-default">
        {/* App content */}
        <div className="bg-default min-h-[420px] relative">
          ...
          <div className="relative z-10 p-4 space-y-4 max-w-lg mx-auto">
            {/* Post 1 */}
            <div className="bg-surface p-5 border border-default rounded-lg shadow-brand">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full border-2 border-default bg-primary flex items-center justify-center shadow-brand text-surface text-sm font-bold">
                  S
                </div>
                <div>
                  <h4 className="font-bold text-default text-sm">Sarah Mitchell</h4>
                  <p className="text-xs text-dim">@sarah_quilts &middot; 2h ago</p>
                </div>
              </div>
              ...
              <div className="flex gap-1 pt-2">
                ...
                <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-bold text-dim hover:bg-default transition-colors duration-150">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 24 24"
            ...
            <div className="bg-surface p-5 border border-default rounded-lg shadow-brand">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full border-2 border-default bg-[#c084fc] flex items-center justify-center shadow-brand text-surface text-sm font-bold">
                  M
                </div>
                <div>
                  <h4 className="font-bold text-default text-sm">Modern Quilter</h4>
                  <p className="text-xs text-dim">@modern_q &middot; 5h ago</p>
                </div>
              </div>
              <p className="text-default mb-3 text-sm leading-relaxed">
...
function FeatureCard({
  ...
  return (
    <div className="bg-surface rounded-lg border border-default shadow-brand p-4 flex items-start gap-3 transition-colors duration-150 hover:bg-default">
      <div className="w-10 h-10 rounded-full bg-[#ff8d49]/10 flex items-center justify-center text-primary flex-shrink-0">
        {icon}
      </div>
      <div>
        <h4
          className="font-bold text-default text-sm mb-1"
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <h2
              className="text-[32px] leading-[40px] md:text-[40px] md:leading-[52px] lg:text-[48px] lg:leading-[56px] font-bold text-default leading-tight"
              style={{ fontFamily: 'var(--font-display)' }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link
                href="/socialthreads"
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-default rounded-full font-bold text-lg hover:bg-primary-dark transition-colors duration-150 shadow-brand"
              >
