  ...
  return (
    <section className="px-6 lg:px-12 py-16 lg:py-24 bg-[var(--color-bg)] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="bg-[#ff8d49]/10 p-10 md:p-16 text-center border border-[var(--color-border)] rounded-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2
              className="text-[32px] leading-[40px] md:text-[36px] md:leading-[44px] font-bold text-[var(--color-text)] mb-4"
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Ready to Start Your Next Quilting Adventure?
            </h2>
            <p className="text-[18px] leading-[28px] text-[var(--color-text-dim)] mb-8 max-w-xl mx-auto">
            ...
            <Link
              href="/auth/signup"
              className="px-8 py-4 bg-[#ff8d49] text-[var(--color-text)] rounded-full font-bold text-lg hover:bg-[#e67d3f] transition-colors duration-150 shadow-[0_1px_2px_rgba(45,42,38,0.08)] inline-block"
            >
