...
export function ResizeDialog({ isOpen, onClose }: ResizeDialogProps) {
  ...
  return (
    ...
    >
      <div
        className={`bg-[var(--color-bg)] rounded-lg shadow-[0_1px_2px_rgba(54,49,45,0.08)] w-[${LAYOUT.dialogSm}] max-w-[90vw]`}
        role="dialog"
        aria-label="Resize Quilt"
      >
        {step === null ? (
          <div className="p-6">
            <h2 className="text-title-lg text-[var(--color-text)] font-semibold mb-4">
              Resize Quilt
            </h2>
            ...
            <div className="flex items-end gap-3 mb-4">
              <div className="flex-1">
                <label
                  ...
                  className="block text-label-sm text-[var(--color-text-dim)] mb-1"
                >
                  Width ({unitLabel})
                </label>
                <input
            ...
            <p className="text-body-sm text-[var(--color-text-dim)] mb-4">
          ...
          <div className="p-6">
            <h2 className="text-title-lg text-[var(--color-text)] font-semibold mb-2">
              Confirm Resize
            </h2>
