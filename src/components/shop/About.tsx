      ...
      <div className="w-full px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:pl-8">
            ...
            <p className="text-lg leading-relaxed mb-6" style={{ color: COLORS.textDim }}>
              QuiltCorgi started in a studio apartment and grew into a community of makers. We
              design prints, curate palettes, and ship orders with care—so you can focus on the fun
              part: sewing.
            </p>
            <p className="text-lg leading-relaxed mb-8" style={{ color: COLORS.textDim }}>
              Every fabric in our shop is chosen with intention. We believe quilting is more than a
              hobby—it&apos;s a way to create warmth, share stories, and connect with others.
            </p>
            <a
              href="#"
