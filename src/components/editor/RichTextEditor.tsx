  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        onInput={handleInput}
        onBlur={handleInput}
        className="min-h-[300px] max-h-[600px] overflow-y-auto p-4 bg-surface border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 prose-quiltcorgi"
