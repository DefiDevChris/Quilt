 ...
 *
 * Reads all parsed layout JSON files from src/data/patterns/,
...
/**
 * Load all valid layout JSON files from the patterns directory,
...
function loadPatternFiles(): ParsedPattern[] {
  ...
  for (const entry of entries) {
    ...
    try {
      ...
      console.warn(`Failed to parse layout file ${entry.name}:`, error);
    }
  }
...
/**
 * Build a seed record from a parsed layout.
 */
