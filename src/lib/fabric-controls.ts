...
import { COLORS, withAlpha } from './design-system';
...
function renderCornerHandle(
  ...
  // Drop shadow
  ctx.shadowColor = withAlpha(COLORS.text, 0.15);
  ctx.shadowBlur = 4;
  ctx.shadowOffsetX = 0;
  ctx.shadowOffsetY = 1;
...
function renderMidpointHandle(
  ...
  ctx.shadowColor = withAlpha(COLORS.text, 0.1);
  ctx.shadowBlur = 3;
  ctx.shadowOffsetX = 0;
  ctx.shadowOffsetY = 1;
...
function renderRotationHandle(
  ...
  // Circle handle
  ctx.shadowColor = withAlpha(COLORS.text, 0.2);
  ctx.shadowBlur = 4;
  ctx.shadowOffsetX = 0;
  ctx.shadowOffsetY = 1;
